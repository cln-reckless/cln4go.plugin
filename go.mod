...
require (
	github.com/vincenzopalazzo/cln4go/client v0.0.0-20230413130716-35626bd3b34b
	github.com/vincenzopalazzo/cln4go/plugin v0.0.0-20230413130716-35626bd3b34b
)
